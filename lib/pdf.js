...
// links). The deployed app has normal internet access, so this works in
// production even though it can't be tested from a network-restricted
// sandbox. Any failure just skips the logo instead of breaking PDF generation.
